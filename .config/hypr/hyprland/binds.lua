...
-- Toggle: fit current column to viewport / restore default width
local _colFitted = false
...
hl.bind(
	...
	hl.dsp.exec_cmd(scripts .. "/play-sound.sh volume-up & pactl set-sink-volume @DEFAULT_SINK@ +5%")
)
hl.bind(
	"XF86AudioLowerVolume",
	hl.dsp.exec_cmd(scripts .. "/play-sound.sh volume-down & pactl set-sink-volume @DEFAULT_SINK@ -5%")
)
hl.bind(
	"XF86AudioMute",
	hl.dsp.exec_cmd(scripts .. "/play-sound.sh volume-mute & wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle")
)
