...
if [ -f ~/.config/andriel/settings/wallpaper_cache ]; then
	use_cache=1
...
force_generate=0
generatedversions="$HOME/.config/andriel/cache/wallpaper-generated"
waypaperrunning=$HOME/.config/andriel/cache/waypaper-running
cachefile="$HOME/.config/andriel/cache/current_wallpaper"
blurredwallpaper="$HOME/.config/andriel/cache/blurred_wallpaper.png"
squarewallpaper="$HOME/.config/andriel/cache/square_wallpaper.png"
rasifile="$HOME/.config/andriel/cache/current_wallpaper.rasi"
blurfile="$HOME/.config/andriel/settings/blur.sh"
defaultwallpaper="$HOME/.config/backgrounds/wallpapers/Lofi-Cafe2.png"
wallpapereffect="$HOME/.config/andriel/settings/wallpaper-effect.sh"
blur="50x30"
blur=$(cat $blurfile)
